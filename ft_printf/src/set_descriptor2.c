...
/*   Updated: 2018/03/19 15:55:27 by adubugra         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/ft_printf.h"

void	set_arg2(t_descriptor *descriptor);
...
void	set_base(t_descriptor *descriptor)
{
	if (descriptor->type == 'x' || descriptor->type == 'X')
		...
		descriptor->base = 8;
	else if (!NOT_TYPE_D(descriptor->type) || !NOT_TYPE_U(descriptor->type))
		descriptor->base = 10;
	else
		descriptor->base = 0;
}
